...
(function (a, b, c) {
    ...
    j = function (a) {
        ...
        var d;
        return d = function () {
        }, d.prototype = a, b.extend(!0, new d, c)
    }, n = function (a) {
        ...
        password: null,
        username: null,
        verbs: {create: "POST", read: "GET", update: "PUT", destroy: "DELETE"},
        ajax: {dataType: "json"}
    }, d = function () {
        function a(a) {
        ...
        return a.prototype.valid = function (a) {
            var b;
            return b = (new Date).getTime() - a.getTime(), b <= 1e3 * this.parent.opts.cache
        }, a.prototype.key = function (a) {
            var c, d = this;
            return c = "", b.each(a, function (a, e) {
        ...
        return a.prototype.call = function () {
            var a, b, c;
            return c = this.parent.extractUrlData(this.method, arguments), b = c.url, a = c.data, this.custom && (b += this.opts.url || this.name), this.parent.ajax.call(this, this.method, b, a)
        ...
        return a.prototype.constructRoot = function (a) {
            ...
            for (k = [], g = null, m = null, q = 0, s = c.length; s > q; q++) d = c[q], o = b.type(d), "string" === o || "number" === o ? k.push(d) : "object" === o && null === g ? g = d : "object" === o && null === m ? m = d : j("Invalid argument: " + d + " (" + o + "). Must be strings or ints (IDs) followed by one optional object and one optional query params object.");
            for (n = k.length, e = "create" !== a, f = "update" !== a && "delete" !== a, p = null, e && n === this.expectedIds && (p = this.url), f && n === this.expectedIds - 1 && (p = this.urlNoId), null === p && (f && (l = this.expectedIds - 1), e && (l = (l ? l + " or " : "") + this.expectedIds), j("Invalid number of ID arguments, required " + l + ", provided " + n)), h = r = 0, t = k.length; t > r; h = ++r) i = k[h], p = p.replace(new RegExp("/:ID_" + (h + 1) + "/"), "/" + i + "/");
            return m && (p += "?" + b.param(m)), {url: p, data: g}
        }, a.prototype.ajax = function (a, c, d) {
            var e, f, g, h, k, l, n, o = this;
            return a || j("method missing"), c || j("url missing"), h = {}, this.opts.username && this.opts.password && (f = i(this.opts.username + ":" + this.opts.password), h.Authorization = "Basic " + f), d && this.opts.stringifyData && "GET" !== a && "HEAD" !== a && (d = m(d), h["Content-Type"] = "application/json"), this.opts.methodOverride && "GET" !== a && "HEAD" !== a && "POST" !== a && (h["X-HTTP-Method-Override"] = a, a = "POST"), this.opts.stripTrailingSlash && (c = c.replace(/\/$/, "")), e = {
                url: c,
                type: a,
                headers: h
            }, d && (e.data = d), e = b.extend(!0, {}, this.opts.ajax, e), n = this.opts.cache && b.inArray(a, this.opts.cachableMethods) >= 0, n && (k = this.root.cache.key(e), l = this.root.cache.get(k)) ? l : (this.opts.cache && this.opts.autoClearCache && -1 === b.inArray(a, this.opts.cachableMethods) && (g = c.replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"), this.root.cache.clear(new RegExp(g))), l = this.opts.request(this.parent, e), n && l.done(function () {
